...
using proteinOceanVis2022.Models;

namespace proteinOceanVis2022.Controllers
{
    public class TarikController : Controller
    {
        // GET: Tarik
        tarikDBEntities5 db = new tarikDBEntities5(); 
        // tarikDBEntitiesEv db = new tarikDBEntitiesEv();
        ...
        public ActionResult sepeteekle(int id)
        {
            ...
            {
                return RedirectToAction("girisyap", "Tarik", new { mesaj = "sepete eklemek için önce oturum açın" });
            }
            else
            {
        ...
        public ActionResult adminana()
        {
            ...
            {
                return RedirectToAction("index", "Tarik"); 
            }
            var degerler = db.urunTable.ToList();
            return View(degerler);
        }
